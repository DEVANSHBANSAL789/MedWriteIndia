...
const navItems = [
  ...
  },
  {
    ...
    href: '/courses',
    dropdown: [
      { label: 'Introduction to Medical Writing', href: '/courses', badge: 'Beginner' },
      { label: 'Clinical Research Documentation', href: '/courses', badge: 'Beginner–Intermediate' },
      { label: 'Scientific Manuscript Writing', href: '/courses', badge: 'Intermediate' },
      { label: 'Regulatory Writing Fundamentals', href: '/courses', badge: 'Intermediate' },
      { label: 'Patient Education Writing', href: '/courses', badge: 'Beginner' },
      { label: 'Freelance Medical Writing Skills', href: '/courses', badge: 'All Levels' },
      { label: 'Ethics in Healthcare Communication', href: '/courses', badge: 'All Levels' },
      { label: 'Medical Editing & Proofreading', href: '/courses', badge: 'Beginner–Intermediate' },
